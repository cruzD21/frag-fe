...
export default function SearchOutput({results, input, active}: OutputProps) {
    if(input === '' ) {
        return null
    }
    ...
    return (
        <div className="absolute top-full w-full z-10 overflow-y-auto max-h-40">
            {results?.map((frag) => {
                return (
                    <div key={frag.frag_id} className="bg-white flex text-left p-2">
                        <img 
